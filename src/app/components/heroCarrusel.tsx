...
export function HeroCarousel() {
  const slides = useMemo<Slide[]>(
    () => [
      // Para usar el banner Bloom manualmente, sube la imagen a public/brand/
      // y agrega aquí un slide con su ruta, por ejemplo: /brand/banner-bloom-impermeabilizacion.png.
